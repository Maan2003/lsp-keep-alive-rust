...
impl Message {
    pub async fn read(r: &mut (impl AsyncBufRead + Unpin)) -> io::Result<Option<Message>> {
...
async fn read_msg_text(inp: &mut (impl AsyncBufRead + Unpin)) -> io::Result<Option<String>> {
